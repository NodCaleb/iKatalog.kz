...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div class="title_mid">Профессиональная косметика для волос, лица и тела<br/>ведущих мировых брендов,</div>
	<div class="title_big">L’Oreal&nbsp;Weleda&nbsp;Kerastase&nbsp;Nyx&nbsp;Clarins</div>
	...
	<%--<p><input type="checkbox" checked="checked" name="agree" value="1">Я принимаю <a href="http://ikatalog.kz/StaticPages.aspx?Page=2" target="_blank">условия соглашения</a> для первого заказа </p>--%>
        <p>Выглядеть молодо и привлекательно – это удовольствие. Его обеспечивают качественные крема, лосьоны, тоники, декоративная косметика.<br/>Купить действительно оригинальную и правильную косметику в обычном магазине довольно сложно. А вот покупка в каталогах – это:</p>
        <ul style="margin-left: 20%;">
			<li style="text-align: left;">прямые поставки из Европы</li>
			<li style="text-align: left;">приятные цены</li>
			<li style="text-align: left;">неизменно высокое качество</li>
			<li style="text-align: left;">и обязательно &ndash; масса приятных впечатлений от покупки</li>
		</ul>
		<p>У нас на сайте Вы можете:</p>
		<ul style="margin-left: 20%;">
			<li style="text-align: left;">выбирать косметику известных брендов из популярных каталогов Hagel, BioNaturel, HairShop Pro и др.</li>
			<li style="text-align: left;">экономить на покупке профессиональной косметики до 50%</li>
			<li style="text-align: left;">получить консультацию менеджера и сопровождение заказа с момента оформления и до доставки</li>
			<li style="text-align: left;">всегда быть в курсе последних новинок в сфере профессионального ухода за кожей и волосами</li>
		</ul>
    </div>
    ...
    <div class="colorblock whiteblock">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="cats">
	        <tbody>
		        <tr>
			        <td><a href="http://ikatalog.kz/CatalogueView.aspx?Catalogue=HAGEL" target="_blank"><img style="max-width: 150px; max-height: 100px;" src="http://ikatalog.kz/Images/Logos/hagel.jpg" /></a></td>
			        <td><a href="http://ikatalog.kz/CatalogueView.aspx?Catalogue=BioNaturel" target="_blank"><img style="max-width: 150px; max-height: 100px;" src="http://ikatalog.kz/Images/Logos/bio-naturel.jpg" /></a></td>
			        <td><a href="http://ikatalog.kz/CatalogueView.aspx?Catalogue=HAIRSHOP%20PRO" target="_blank"><img style="max-width: 150px; max-height: 100px;" src="http://ikatalog.kz/Images/Logos/hairshop.png" /></a></td>
			        <td><a href="http://www.kikocosmetics.de/" target="_blank"><img style="max-width: 150px; max-height: 100px;" src="http://ikatalog.kz/Images/Logos/kikocosmetics.jpg" /></a></td>
			        <td><a href="http://www.douglas.de/douglas/" target="_blank"><img style="max-width: 150px; max-height: 100px;" src="http://ikatalog.kz/Images/Logos/DOUGLAS.png" /></a></td>
			        <td><a href="http://ikatalog.kz/CatalogueView.aspx?Catalogue=Zoeva" target="_blank"><img style="max-width: 150px; max-height: 100px;" src="http://ikatalog.kz/Images/Logos/zoeva.png" /></a></td>
		        </tr>
		        <tr>
			        <td>&nbsp;</td>
			        <td>&nbsp;</td>
			        <td colspan="2" style="height: 35px; background-color: #ED9E7C; font-weight: bold; border-radius: 5px;"><a href="http://ikatalog.kz/Catalogues.aspx?Tag=active" target="_blank">КАТАЛОГ ИНТЕРНЕТ-МАГАЗИНОВ!</a></td>
			        <td>&nbsp;</td>
			        <td>&nbsp;</td>
		        </tr>
	        </tbody>
