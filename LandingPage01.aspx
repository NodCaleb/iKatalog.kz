<%@ Page Title="" Language="C#" MasterPageFile="~/iKMasterPage.master" AutoEventWireup="true" CodeFile="LandingPage01.aspx.cs" Inherits="About" %><asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">    <title>iKatalog - заказ товаров по каталогам</title>
	...
	<ul>
	    <li>Компания Internet Katalog, это удобные заказы прямо из дома, любых товаров из Европы, без накруток розничных сетей и перекупщиков.</li>
	    <li>Мировые бренды до 50% дешевле, с доставкой на дом, безопасно и быстро!</li>
	    <li>Для заказа не обязательно ехать в наш офис, достаточно заполнить форму быстрой заявки или просто позвонить нам!</li>
	    <li>Бесплатный самовывоз заказа со склада в Алматы или курьерская доставка в Алматы до двери с примеркой заказанной одежды по вашему адресу! Курьерская доставка в любой регион Казахстана!</li>
	    <li>Удобные способы оплаты: принимаем наличные платежи и оплату банковской картой! Без ограничений и комиссий за перевод денег!</li>
	    <li>Возврат товара в течении 365 дней (при сохранении упаковки и документов)!</li>
	</ul>
    </div>
	...
	<div id="cataloguesdisplay">
	    ...
	    <div class="more"><a href="http://ikatalog.kz/Catalogues.aspx?Tag=active" target="_blank">Это самые популярные, а всего их около 80-ти, нажмите, чтобы открыть полный список >>></a></div>
	</div>
    </div>
    <div class="question">
	<div id="show2">
	...
	<div id="pricedisplay">
		...
		<table>
		    <tbody>
				...
				<td>
				    Стоимость доставки до Казахстана: 5-7€/кг. + доставка по городу или в регион
				</td>
			    </tr>
		    </tbody>
		</table>
		<p>К примеру — джинсы с каталога <a href="http://www.c-and-a.com/de/de/shop/index.html" taget="_blank">C&amp;A</a> за 15€. Комиссия каталога составит 22%. Вес джинсов примерно 400 грамм. Итого джинсы вам обойдутся: 15€ + 22% + 0,4 кг.*5€ = 20,3€, что в тенге составит около 4 700 тг.</p>
	    </div>
	</div>
    </div>
    <div class="question">
	...
	<div id="orderdisplay">
		...
		<table>
		    <tbody>
			    ...
			    <tr>
				<td>
				    Выберите интетесующий ват товар из <a href="http://ikatalog.kz/Catalogues.aspx?Tag=active" target="_blank">более чем 80 каталогов</a>
				</td>
				<td>
