<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/SideModulesAccount.master" AutoEventWireup="true" CodeFile="OrdersHistory.aspx.cs" Inherits="Admin_OrderManagement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>iKatalog - история заказов</title>
            ...
            <asp:GridView ID="OrderDetailsGridView" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Действия">
                        <ItemTemplate>
                            <%--<asp:LinkButton ID="ReorderLine" runat="server" CommandName="ReorderLine" CommandArgument='<%# Bind("Line_id") %>' CausesValidation="false" >Перезаказать</asp:LinkButton>--%>
