<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/SideModulesAccount.master" AutoEventWireup="true" CodeFile="EcomPaymentAutomatedSuccess.aspx.cs" Inherits="Admin_OrderManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<asp:Panel id="NoPaymentPanel" runat="server">
		<h2>Уупс!</h2>
		<p>Похоже, что от вы совершили платеж через систему eComCharge, но мы не можем его отыскать.</p>
	...
	<asp:Panel id="PaymentPanel" runat="server" visible="false">
		<h2>Благодарим:</h2>
		<p>От вас был принят платеж через платежную систему eComCharge на сумму <asp:Label ID="AmmountLabel" runat="server" Text=''></asp:Label> евро.</p>
		<p>Номер транзакции: <asp:Label ID="PaymentNoLabel" runat="server" Text=''></asp:Label> (запишите его на всякий случай).</p>
