<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EcomPaymentsLog.aspx.cs" Inherits="Admin_OrderManagement" %>
    ...
    <asp:SqlDataSource ID="PaymentsSource" runat="server" ConnectionString="<%$ ConnectionStrings:iKConnectionString %>"
        SelectCommand="        
            select
				...
				P.Ammount
			from
				EcomChargePayments as P with (nolock)
